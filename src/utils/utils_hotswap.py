...
def modify_TREC_dataset():
    ...
    new_dataset = {
        ...
        "in2i": new_in2i,
        "i2in": new_i2in,
        "query_train": new_query_train,
        "intent_train": new_intent_train,
        "query_dev": new_query_dev,
        "intent_dev": new_intent_dev,
        "query_test": new_query_test,
        "intent_test": new_intent_test,
    }
    pickle.dump(
        new_dataset, open("../data/{}/dataset.hotswap.pkl".format("TREC"), "wb")
    )
